...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Activities', path: '/activities', entity: 'activity', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Reservations',
      path: '/reservations',
      entity: 'reservation',
    ...
    { name: 'Rooms', path: '/rooms', entity: 'room', service: AccessServiceEnum.PROJECT, icon: FiBox },
    {
      name: 'Team Members',
      path: '/team-members',
      entity: 'team_member',
