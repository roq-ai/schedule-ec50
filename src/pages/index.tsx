  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to SCHEDULE, your comprehensive web app for room booking. Choose a room, select a date, view scheduled activities, and make your reservation with ease. Start organizing your space today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to SCHEDULE, your comprehensive web app for room booking. Choose a room, select a date, view scheduled activities, and make your reservation with ease. Start organizing your space today.`}
            </Text>
            <Box
